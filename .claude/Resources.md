...
- **[Shpigford/clearly](https://github.com/Shpigford/clearly)** — native AppKit / SwiftUI markdown editor for macOS. Working source-with-decorations editor with a syntax highlighter, fold-state plumbing, and editor shell. Fork-reference for Pommora's SwiftUI Option 1 (native editor; primary path is `swift-markdown` + TextKit 2). License: FSL-1.1-MIT (converts to MIT Feb 2028).
