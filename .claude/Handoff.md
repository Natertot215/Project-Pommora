...
>
> *How to proceed — IN THIS ORDER, before writing one line of code: (1) read `// Planning // Make-Relations-Real-Plan.md` end to end; (2) **review the code one more time** against the plan's claims — line numbers drift, verify don't trust; (3) **ask me questions**, especially anything unclear about the picker UIX or feature requirements — I'd rather answer five questions than watch you build the wrong thing; (4) then implement what I greenlight (probably Task 8's two fixes first since they block my testing, then Task 4 the picker). Don't guess. Look at the code. Ask me."*
