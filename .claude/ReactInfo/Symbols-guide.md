...
`.nexus// symbols.json` inside the nexus. Seeded on first launch from the canonical icon role table — covers shell / chrome, common actions, entity kinds, sidebar sections, editor formatting, property types, views, and view controls. Format:
