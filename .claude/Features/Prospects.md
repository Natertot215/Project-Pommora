...
**Description:** Items deferred from the v1 Relations Redesign (`// Planning//Relations-Redesign-Plan.md`). Near-term follow-ups (relation chip visual, hierarchical value pickers) are tracked in `Handoff.md` as next-session work, not here. Genuinely post-v1:
