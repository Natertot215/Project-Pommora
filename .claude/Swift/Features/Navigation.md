...
The dropdown always opens Pages in the main detail pane — it does not consult the Collection's `open_in` mode. PagePreview windows are routed from sidebar page-taps only ([[Resources/II. Pommora/II. Swift/II. Features/Pages]] § "Opening behavior").
