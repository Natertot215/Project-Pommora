...
- **Inspector** — the shared property inspector mounted compact, natively resizable (→ [[Resources/II. Pommora/II. Swift/II. Features/Properties]] "Where Properties Live").
...
**From the Navigation — single-click select / double-click open.** Clicking a Page row in the dropdown's Pinned or Recents list updates the dropdown's selection (no action); double-clicking opens the Page in the main detail pane. Full mechanics → [[Resources/II. Pommora/II. Swift/II. Features/Navigation]].

---

#### Hierarchy

Pages live at any depth inside a Collection: the Collection root, or a Set / Sub-Set nested to any depth (see [[Resources/II. Pommora/II. Swift/II. Features/PageSets]]). No forced sub-page nesting; sub-pages (a nested *Page* hierarchy) are a v2 candidate (see [[Prospects]]).
...
Right-click on a Page row in the sidebar gives Rename / Delete; right-click in a Collection or Set detail view gives Rename / Pin (or Unpin) / Delete. For full sidebar layout + creation affordances → [[Resources/II. Pommora/II. Swift/II. Features/Sidebar]].

---

#### Connections

A Page's body can hold inline `[[Page Name]]` connections — Obsidian-compatible wikilinks that render as styled colored inline text in the prose flow (never a chip). Canonical spec → [[Resources/II. Pommora/II. Swift/II. Features/Connections]]; the frontmatter `tier1` / `tier2` / `tier3` context-link counterpart → [[Resources/II. Pommora/II. Swift/II. Features/Properties]].
