...
**1. You may STOP and ASK at any point — this is expected, not a failure.** If a task would make you *guess*, if the specifics aren't pinned down enough that proceeding risks a revision Nathan wouldn't like, or if you hit an assumption this plan didn't anticipate — **halt and ask Nathan before writing code.** A question costs a minute; a wrong guess that ships costs a revision and erodes trust. The cornerstone governs absolutely: *you do NOT guess — you LOOK, you ASK.* When in doubt, ask. This permission is standing and unconditional across all phases.
