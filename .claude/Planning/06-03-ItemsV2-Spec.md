...
#### Description — MarkdownPM, 250-Char Cap
...
- Capped at **250 source chars** (down from the provisional 1000; matches the original 150–250 intent). The description IS the Markdown body — single source of truth, no separate frontmatter description field — so the cap binds the body.
...
- **250-char cap** changes the provisional 1000 (`Paradigm-Decisions.md:58`). Since the body IS the description, the cap binds the Markdown body — define behavior when a raw-Obsidian edit exceeds it.
