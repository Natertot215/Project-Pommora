...
- `2026-06-01-Items-as-Markdown-Plan.md` — convert Items from whole-`.json` to plain `.md` (Shape A; one `AtomicYAMLMarkdown` pipeline; folder-sidecar kind authority; foreign-key preservation; auto-run migration). Ratified as registry decision #14.
...
`Superseded/` archives plans that have fully shipped or been abandoned. Empty until the first active plan retires there.
