...
/** The CSS colour a link renders in: its stored solid, or the runtime system accent when unset
 *  ("Default"). One source for the URL cell AND the URLEditor's colour chip. */
export function linkColorCss(color: string | undefined): string {
