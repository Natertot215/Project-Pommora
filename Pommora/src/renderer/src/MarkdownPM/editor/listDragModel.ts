...
export function renumberOrderedRun(doc: string, pos: number): ChangeSpec[] {
  ...
  // Lines belonging to an item's subtree — deeper-indented markers or wrapped-item continuations — are
  // skipped, not run terminators: `1. a / ⇥- sub / 2. b` is ONE run and must renumber past the sublist.
