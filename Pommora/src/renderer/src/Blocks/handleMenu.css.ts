...
/** The footing lock — a left-pinned labeled action (icon + Lock/Unlock), the footingLabel tone + hover.
 *  Its divider sits tight (footerDivider), closer than the shared 11px band. */
export const footerDivider = style({ selectors: { '&&': { height: '5px' } } })
export const footerRow = style({ display: 'flex', alignItems: 'center', paddingInline: '6px', paddingBottom: '5px' })
