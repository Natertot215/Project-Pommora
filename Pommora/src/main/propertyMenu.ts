...
import { propertyMenuModel, type PropertyMenuAction, type PropertyMenuContext } from '@shared/propertyMenu'
...
export function popPropertyMenu(win: BrowserWindow, ctx: PropertyMenuContext): Promise<PropertyMenuAction | null> {
      ...
      items.push({
        ...
        click: async () => {
          ...
          const { response } = await dialog.showMessageBox(win, {
            ...
            detail: 'It is removed from every collection; a recovery snapshot lands in the nexus’s .trash folder.'
          })
