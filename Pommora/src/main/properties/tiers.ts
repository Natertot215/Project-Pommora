...
// stored user definitions followed by the three pre-configured tier context properties
 ...
 *  - context_target: structurally locked to `{ context_tier, level }` (sidecar ignored)
